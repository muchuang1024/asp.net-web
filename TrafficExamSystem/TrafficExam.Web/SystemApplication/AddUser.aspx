<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddUser.aspx.cs" Inherits="TrafficExam.Web.SystemApplication.AddUser" %>
                            ...
                            <td>
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="73%" class="Adminrighttabletdtext02">
                                            <input checked="checked" type="radio" name="group_Sex" value="男" />男
                                            <input type="radio" name="group_Sex" value="女" />女
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="27%" class="Adminrighttabletdtitle">
                                    ...
                                    <tr>
                                        ...
                                        <td width="73%" class="Adminrighttabletdtext02">
                                            <input type="text" id="txtPassword" value="111111" style="width: 150px; height: 25px;" disabled/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="27%" class="Adminrighttabletdtitle">
                                        ...
                                        <td width="73%" class="Adminrighttabletdtext02">
                                            <input type="text" id="txtRepeatPassword" value="111111" style="width: 150px; height: 25px"
                                                disabled />
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <table width="100%" border="0">
                                    <tr>
                                        <td height="53" align="center">
                                            <input id="btnAdd" type="submit" class="Adminrighttablebtn" value="添加" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
