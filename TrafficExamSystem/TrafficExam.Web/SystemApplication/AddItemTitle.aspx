<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddItemTitle.aspx.cs" Inherits="TrafficExam.Web.AddItemTitle" %>
...
<head id="Head1" runat="server">
    ...
    <script src="Scripts/AddItemTitle.js" type="text/javascript"></script>
                                ...
                                <table width="100%" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="Adminrighttabletdtext02">
                                            <input type="text" id="Adminrighttabletdtitle" style="height: 25px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="27%" class="Adminrighttabletdtitle">
                                        ...
                                        <td width="73%" class="Adminrighttabletdtext02">
                                            ...
                                            </span>&nbsp;&nbsp; <span><strong><font color="red">*勾选复选框表示该答案项是正确答案</font></strong></span>
                                        </td>
                                    </tr>
                                    <tr id="firstanswer">
                                        <td class="Adminrighttabletdtitle">
