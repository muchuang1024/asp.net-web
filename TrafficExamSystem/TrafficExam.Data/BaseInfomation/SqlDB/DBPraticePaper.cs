...
{
    public class DBPraticePaper : IPraticePaper
    {
        ...
        public IList<PraticePaper> GetPaperInfo(string TableName, int titleId, string loginName)
        {
            ...
            IList<PraticePaper> list = IListHelper.DataSetToIList<PraticePaper>(ds, 0);
            return list;
        }
        #endregion
        ...
        public bool SetPaperList(string loginName, string TableName)
        {
            if (!IsExisted(loginName))
            {
                ...
                return SqlHelper.ExecuteSqlText(CommandType.StoredProcedure, "Proc_GetPraticePaper", sp);
            }
            else
            {
                return true;
        ...
        {
            string strSql = "Update PraticePaper Set UserAnswer='" + userAnswer + "',IsProper='" + isProper + "'";
            strSql += " where  TitleId=" + titleId + " and LoginName='" + loginName + "'";
        ...
        {
            string strSql = "select Count(PaperId) PraticePaper from   where LoginName=@loginName";
        ...
        {
            string strSql = "select PaperId,TitleId,UserAnswer,SubjectItem,IsProper  From PraticePaper";
