...
{
    public interface IPraticePaper
    {
        ...
        /// <returns></returns>
        IList<PraticePaper> GetPaperInfo(string TableName,int titleId, string loginName);
       ...
       /// <param name="loginName">用户名</param>
        ...
        /// <returns></returns>
        IList<PraticePaper> GetIsProperList(string loginName);
    }
