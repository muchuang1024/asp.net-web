...
namespace TrafficExam.Command
{
    public class ExcelHelper
    {
        ...
        /// <param name="dtSource">源DataTable</param>   
        /// <param name="strHeaderText">表头文本</param>   
        /// <param name="strSheetName">工作表名称</param>D:\TrafficExamSystem\TrafficExam.Command\NPOIHelper\ExcelHelper.cs
        /// <Author></Author>   
        ...
        #region 下面方法是将Excel导入到DataTable
