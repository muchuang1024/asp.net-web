<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage2.master" AutoEventWireup="true" CodeFile="bbs_editpwd.aspx.cs" Inherits="html_bbs_editpwd" %>
...
<script type="text/javascript">
    ...
    function CheckUserInfo() {
        ...
        if ($.trim($("#TextBox4").val()) != $.trim($("#TextBox5").val())) {
            alert("两次输入的密码不一致！！");
            $("#TextBox4").val("");
            $("#TextBox5").val("");
            return false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height:auto;width:900px">
        ...
        Width="187px" />
            <font style="font-size:15px; font-weight:bold">用户资料修改中心</font>
        </div>
  ...
  <tr> 
   <th scope="col" abbr="Dual 2" class="style1">输入旧密码</th> 
  ...
  <tr> 
    ...
    <th scope="col" abbr="Dual 2" class="style1">新密码：</th> 
  ...
  <tr> 
    ...
    <td class="style3">
        ...
        <asp:Button ID="Button1" runat="server" onclick="Button1_Click" Text="确认修改" OnClientClick="return CheckUserInfo()" CssClass="button" />
